...
export function Footer() {
  return (
    <footer className="flex flex-col items-start gap-5 bg-[#10243b] px-5.5 py-7.5 text-white md:flex-row md:items-center md:justify-between md:px-[max(6vw,40px)] md:py-9.25">
