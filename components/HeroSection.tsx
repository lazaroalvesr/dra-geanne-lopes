...
export function HeroSection() {
  return (
    <section id="inicio" className="reveal-section relative flex min-h-155 flex-col overflow-hidden bg-[linear-gradient(120deg,rgba(224,200,160,0.42),rgba(243,243,243,0.92)_70%)] px-5.5 py-21.25 md:h-auto md:min-h-0 md:px-[max(6vw,40px)] md:py-16 lg:h-162.5 lg:min-h-[calc(100vh-84px)] lg:flex-row lg:py-17.5">
      ...
      <div className="reveal-item relative z-10 max-w-200">
