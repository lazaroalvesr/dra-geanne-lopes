  ...
  return (
    <section id="contato" className="reveal-section grid gap-14 bg-[#E0C8A073] px-5.5 py-20 md:grid-cols-2 md:gap-[clamp(60px,10vw,150px)] md:px-[max(6vw,40px)] md:py-30">
      <div className="reveal-item">
        ...
        <div className="mt-9.5 grid max-w-115 gap-4.25 border-t border-[#0A272333] pt-6.75 text-[#0A2723]"><div className="grid gap-1 md:grid-cols-[145px_1fr] md:gap-3"><span className="text-[10px] font-bold tracking-[1px] text-[#D1AD7D]">TELEFONE</span><Link className="text-[13px]" href={`tel:${contactDetails.phoneE164}`}>{contactDetails.phoneDisplay}</Link></div><div className="grid gap-1 md:grid-cols-[145px_1fr] md:gap-3"><span className="text-[10px] font-bold tracking-[1px] text-[#D1AD7D]">E-MAIL</span><Link className="text-[13px]" href="mailto:contato@geannelopes.adv.br">contato@geannelopes.adv.br</Link></div><div className="grid gap-1 md:grid-cols-[145px_1fr] md:gap-3"><span className="text-[10px] font-bold tracking-[1px] text-[#D1AD7D]">ESCRITÓRIO CENTRAL</span><p className="m-0 text-[13px]">{contactDetails.address}</p></div></div>
      </div>
